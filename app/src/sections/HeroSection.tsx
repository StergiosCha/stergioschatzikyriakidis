...
const HeroSection = () => {
  ...
  if (isMobile) {
    return (
      <section ref={sectionRef} id="hero" className="min-h-screen bg-paper px-6 pt-24 pb-12 flex flex-col">
        ...
        <div ref={headlineRef}>
          <h1 className="text-ink leading-[1] text-4xl font-semibold">
            Stergios
            <br />
            Chatzikyriakidis
          </h1>
        </div>
        <p ref={subtitleRef} className="text-mut text-sm leading-relaxed mt-4">
        ...
        <div ref={ctaRef} className="flex flex-col gap-3 mt-6">
          <div className="flex flex-wrap gap-3">
            ...
            <a href="/cv_cha.pdf" download="cv_cha.pdf" className="btn-secondary">
              <Download size={18} />
              Download CV
            </a>
          </div>
          <div className="flex items-center gap-4 mt-2">
            <a href="https://scholar.google.com/citations?user=dAYpE3MAAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-mut hover:text-terra transition-colors" title="Google Scholar">
            ...
            <a href="https://www.researchgate.net/profile/Stergios-Chatzikyriakidis" target="_blank" rel="noopener noreferrer" className="text-mut hover:text-terra transition-colors" title="ResearchGate">
            ...
            <a href="https://github.com/StergiosCha" target="_blank" rel="noopener noreferrer" className="text-mut hover:text-terra transition-colors" title="GitHub">
            ...
            <a href="https://huggingface.co/Stergios" target="_blank" rel="noopener noreferrer" className="text-mut hover:text-terra transition-colors" title="Hugging Face">
  ...
  return (
    ...
    >
      <div className="section-content">
        ...
        >
          <h1 className="text-ink leading-[1]" style={{ fontSize: 'clamp(36px, 5vw, 72px)' }}>
            Stergios
            <br />
            Chatzikyriakidis
          </h1>
