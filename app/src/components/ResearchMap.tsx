...
const areas: ResearchArea[] = [
  {
    id: 'dl-nlu',
    label: 'Deep Learning, NLU, Explainability & Neuro-Symbolic Systems',
    methodology: 'computational',
    description: 'NLI evaluation, annotation artifacts, neuro-symbolic integration with Coq, LLM critique and explanation.',
    publications: [
      { number: 13, title: 'Neural-Symbolic NLP: Bridging Theory and Practice' },
      { number: 27, title: 'Neuro-Symbolic NLP: Taxonomy, Assessment, and Directions' },
      { number: 43, title: 'Natural Language Inference in Coq' },
      { number: 53, title: 'Zeugma: A Neuro-Symbolic System for Reasoning Over LLM-Generated Knowledge Graphs' },
      { number: 59, title: 'Reverse Engineering NLI: A study of the meta-inferential properties of Natural Language Inference' },
      { number: 82, title: 'A Wide-Coverage Symbolic Natural Language Inference System' },
      { number: 83, title: 'Testing the Generalization Power of Neural Network Models Across NLI Benchmarks' },
      { number: 85, title: 'What kind of Natural Language Inference are NLP systems learning: Is this enough?' },
      { number: 91, title: 'A Type-Theoretical System for the FraCaS Test Suite: Grammatical Framework Meets Coq' },
      { number: 66, title: 'How Does Data Corruption Affect Natural Language Understanding Models? A Study on GLUE datasets' },
      { number: 73, title: 'NLI Data Sanity Check: Assessing the Effect of Data Corruption on Model Performance' },
      { number: 92, title: 'An Overview of Natural Language Inference Data Collection: The Way Forward?' },
    ],
  ...
  {
    id: 'greek-nlp',
    label: 'NLP for Greek, its Dialects & Under-Resourced Languages',
    methodology: 'computational',
    ...
    publications: [
      ...
      { number: 57, title: 'GRDD+: An Extended Greek Dialectal Dataset with Cross-Architecture Fine-tuning Evaluation' },
      { number: 64, title: 'OYXOY: A Modern NLP Test Suite for Modern Greek' },
      { number: 56, title: 'Perplexity as a Metric for Dialectal Distance: A Computational Study of Greek Varieties' },
      { number: 68, title: 'Fine-grained Entailment: Resources for Greek NLI and Precise Entailment' },
    ],
  ...
  {
    id: 'arabic',
    label: 'NLP for Arabic Dialects & Language Distance Models',
    methodology: 'computational',
    ...
    publications: [
      ...
      { number: 67, title: 'Pre-trained models or Feature Engineering? The Case of Dialectal Arabic' },
  ...
  },
  {
    ...
    publications: [
      { number: 109, title: 'Reasoning with RAGged events: RAG-Enhanced Event Knowledge Base Construction and reasoning with proof-assistants' },
      { number: 55, title: 'LLMs Got Rhyme? Hybrid Phonological Filtering for Greek Poetry Rhyme Detection and Generation' },
      { number: 61, title: 'Poetry in RAGs: Modern Greek interwar poetry generation using RAG and contrastive training' },
      { number: 54, title: 'HeptaTAX: A Neuro-Symbolic Pipeline and Benchmark for Classifying 16th-Century Heptanesian Notarial Acts' },
      { number: 53, title: 'Zeugma: A Neuro-Symbolic System for Reasoning Over LLM-Generated Knowledge Graphs' },
    ],
  ...
  {
    id: 'type-theory',
    label: 'Type-Theoretic Semantics & Proof Assistants',
    methodology: 'formal',
    description: 'Martin-Löf Type Theory for NL semantics, Coq for adjectives, adverbs, copredication, coordination.',
    publications: [
      { number: 4, title: 'Formal Semantics in Modern Type Theories' },
      { number: 2, title: 'Theories of Types and the Structure of Meaning' },
      { number: 43, title: 'Natural Language Inference in Coq' },
      { number: 39, title: 'Adjectival/adverbial modification: The view from modern type theories' },
      { number: 29, title: 'Dependent Types and Continuations' },
      { number: 96, title: 'Natural Language Reasoning Using Coq: Interaction and Automation' },
      { number: 102, title: 'Natural Language Reasoning Using Proof Technology: Rich Typing and Beyond' },
    ],
  ...
  },
  {
    ...
    publications: [
      ...
      { number: 31, title: 'A Computational Treatment of Anaphora and its Algorithmic Implementation' },
      { number: 84, title: 'Bayesian Inference Semantics: A Modelling System and A Test Suite' },
      { number: 71, title: 'From Compositional Semantics to Bayesian Pragmatics via Logical Inference' },
      { number: 76, title: 'How does Punctuation Affect Neural Models in Natural Language Inference' },
    ],
  ...
  },
  {
    ...
    publications: [
      { number: 51, title: 'GeoAffect: A Multi-Layer Annotation Schema and Few-Shot LLM Evaluation for Geoaffective Analysis of Literary Texts' },
      { number: 54, title: 'HeptaTAX: A Neuro-Symbolic Pipeline and Benchmark for Classifying 16th-Century Heptanesian Notarial Acts' },
      { number: 62, title: 'Literary Translation and Electronic Text Corpus: Compilation and processing of a parallel diachronic French-Greek literary corpus' },
    ],
  ...
  },
  {
    ...
    publications: [
      ...
      { number: 40, title: 'Afterthoughts in Greek: Gender Mismatches Under a Dynamic Framework' },
      { number: 63, title: 'I hea- umm think that\'s what they say: A Dataset of Inferences from Natural Language Dialogues' },
  ...
  {
    id: 'formal-syntax',
    label: 'Formal Syntax of Greek, Dialects & Diachronic Linguistics',
    methodology: 'formal',
    description: 'Clitic systems (Cypriot, Griko, Pontic, Northern Greek), Dynamic Syntax, PCC, polydefinites.',
    publications: [
      { number: 44, title: 'A Dynamic Account of the Cypriot Greek Clitic Positioning system' },
      { number: 36, title: 'The Bantu/Romance/Greek Connection Revisited: Processing Constraints in Auxiliary and Clitic Placement from a Cross-linguistic Perspective' },
      { number: 46, title: 'Clitics in Grecia Salentina Greek: A Dynamic account' },
      { number: 45, title: 'Standard Modern and Pontic Greek Person Restrictions: A feature-free Dynamic Account' },
      { number: 25, title: 'Polydefinites as Markers of Prominence: A Unified Analysis of Greek Polydefinites' },
    ],
    connections: ['greek-nlp', 'arabic', 'type-theory', 'dialogue', 'music'],
  },
  {
    id: 'music',
    label: 'Music & Language: Shared Processing Strategies',
    methodology: 'formal',
